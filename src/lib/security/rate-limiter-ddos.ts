...
class RateLimiterDDoS {
  ...
  private async checkGlobalLimit(client: ClientInfo): Promise<RateLimitResult | null> {
  ...
  private async checkIPLimit(client: ClientInfo): Promise<RateLimitResult | null> {
  ...
  private async checkUserLimit(client: ClientInfo): Promise<RateLimitResult | null> {
  ...
  private async checkEndpointLimit(client: ClientInfo): Promise<RateLimitResult | null> {
  ...
  private createResult(allowed: boolean, overrides?: Partial<RateLimitResult>): RateLimitResult {
    return {
      allowed,
      blocked: false,
      challenged: false,
  ...
  private createBlockResult(client: ClientInput, reason: string): RateLimitResult {
    return {
      allowed: false,
      blocked: true,
      challenged: false,
  ...
  private createChallengeResult(client: ClientInput, challenge: any): RateLimitResult {
    return {
      allowed: false,
      blocked: false,
      challenged: true,
