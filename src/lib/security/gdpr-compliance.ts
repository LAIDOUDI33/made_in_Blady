  ...
  private generatePrivacyPolicy(language: string): PrivacyPolicy {
    ...
    const policy: PrivacyPolicy = {
      ...
      sections: [
        ...
        {
          id: 'cookies',
          title: isEnglish ? 'Cookies and Tracking Technologies' : 'Cookies et Technologies de Suivi',
          content: isEnglish
          ...
          required: true,
          gdprArticles: ['Art. 5(3)'],
          order: 6,
        },
        {
          id: 'data_sharing',
          title: isEnglish ? 'Data Sharing and Transfers' : 'Partage et Transfert de Données',
          content: isEnglish
          ...
          required: true,
          gdprArticles: ['Art. 44-49'],
          order: 7,
        },
        {
          id: 'data_security',
          title: isEnglish ? 'Data Security' : 'Sécurité des Données',
          content: isEnglish
        ...
        {
          id: 'retention',
          title: isEnglish ? 'Data Retention' : 'Rétention des Données',
          content: isEnglish
        ...
        },
        {
          ...
          content: isEnglish
            ? `For privacy-related inquiries:\n\n**Data Protection Officer:**\n📧 Email: ${this.config.organization.dpoEmail}\n${this.config.organization.dpoPhone ? `📞 Phone: ${this.config.organization.dpoPhone}` : ''}\n\n**Exercise Your Rights:**\nSubmit requests via your account dashboard or email us directly.`,
          required: true,
          gdprArticles: [],
          order: 11,
        },
